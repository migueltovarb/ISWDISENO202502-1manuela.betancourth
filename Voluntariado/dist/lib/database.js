...
const ACTIVITIES_FILE = path_1.default.join(DATA_DIR, 'activities.json');
const CERTIFICATES_FILE = path_1.default.join(DATA_DIR, 'certificates.json');
const NOTIFICATIONS_FILE = path_1.default.join(DATA_DIR, 'notifications.json');
const POSTULANTES_FILE = path_1.default.join(DATA_DIR, 'postulantes.json');
...
class Database {
    ...
    // Activities
    getActivities() {
        return readJsonFile(ACTIVITIES_FILE);
    }
    ...
    // Certificates
    getCertificates() {
        return readJsonFile(CERTIFICATES_FILE);
    }
    ...
    // Postulantes
    getPostulantes() {
        return readJsonFile(POSTULANTES_FILE);
    }
...
exports.db.initializeSampleData();
